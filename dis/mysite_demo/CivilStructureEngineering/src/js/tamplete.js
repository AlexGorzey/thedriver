...
(function () {
    ...
    (function () {
        ...
        document.addEventListener('scroll', activNavbar);

        function activNavbar() {
            let position = 35 + window.pageYOffset;
            if (position > 0 && position < about.offsetTop) {
                document.querySelector('#myNavbar .navbar-item.active').classList.remove('active');
                document.querySelector('#myNavbar .navbar-item.home').classList.add('active');
            }
            if (position >= about.offsetTop && position < service.offsetTop) {
                document.querySelector('#myNavbar .navbar-item.active').classList.remove('active');
                document.querySelector('#myNavbar .navbar-item.about').classList.add('active');
            }
            if (position >= service.offsetTop && position < project.offsetTop) {
                document.querySelector('#myNavbar .navbar-item.active').classList.remove('active');
                document.querySelector('#myNavbar .navbar-item.service').classList.add('active');
            }
            if (position >= project.offsetTop && position < contact.offsetTop) {
                document.querySelector('#myNavbar .navbar-item.active').classList.remove('active');
                document.querySelector('#myNavbar .navbar-item.project').classList.add('active');
            }
            if (position >= contact.offsetTop && position <= document.body.scrollHeight) {
                document.querySelector('#myNavbar .navbar-item.active').classList.remove('active');
                document.querySelector('#myNavbar .navbar-item.contact').classList.add('active');
            }
        }
